def apply_action(
    ...
    if action == "create":
        ...
        logs.append(
            {
                "phase": phase,
                "action": "course_created_with_template",
                "identifier": sn,
                "detail": detail,
            }
        )
        ...
        logs.append(
            {
                "phase": phase,
                "action": "course_hidden_and_created",
                "identifier": sn,
                "detail": detail,
            }
        )
        ...
        logs.append(
            {
                "phase": phase,
                "action": "alert_teacher_change_recent",
                "identifier": sn,
                "detail": detail,
            }
        )
