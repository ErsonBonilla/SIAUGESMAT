...
export const OPERATIONS_TABS = [
  { key: "crear_cursos", label: "Crear Cursos", component: "etl", entity: null, action: null },
  { key: "crear_usuarios", label: "Crear Usuarios", component: "batch", entity: "users", action: "create" },
  { key: "crear_categorias", label: "Crear Categorías", component: "batch", entity: "categories", action: "create" },
